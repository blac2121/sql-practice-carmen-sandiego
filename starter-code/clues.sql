...
SELECT country.name, countrylanguage.language, countrylanguage.isofficial FROM country
...
SELECT country.name, city.name FROM country
  ...
  AND city.name NOT LIKE 'San Marino';
...
SELECT country.capital, country.name, city.name FROM country
  JOIN city ON city.countrycode = country.code
